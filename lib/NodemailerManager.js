...
var Mail = /** @class */ (function () {
     ...
     */
    Mail.send = function (receiver, subject, body, attachment) {
        return __awaiter(this, void 0, void 0, function () {
            var transporter_1, mailOptions_1, mail, error_1;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, new Promise(function (res, rej) {
                                transporter_1.sendMail(mailOptions_1, function (err, info) {
                                    if (err) {
                                        rej(err);
                    ...
                    case 1:
                        mail = _a.sent();
                        return [2 /*return*/, { success: true, mail: mail }];
                    case 2:
                        error_1 = _a.sent();
